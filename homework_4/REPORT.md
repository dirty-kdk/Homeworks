...
- ![Матрица ошибок для Deep FC на CIFAR-10](plots/cifar_cm_Deep_FC.png)

- ![Матрица ошибок для CNN with Residuals на CIFAR-10](plots/cifar_cm_CNN_with_Residuals.png)
...
- ![Влияние размера ядра](plots/architecture/kernel_size_curves.png)

- ![Визуализация ядер 3x3](plots/architecture/kernels_Kernel_3x3.png)

- ![Визуализация ядер 5x5](plots/architecture/kernels_Kernel_5x5.png)

- ![Визуализация ядер 7x7](plots/architecture/kernels_Kernel_7x7.png)

- ![Визуализация комбинированных ядер](plots/architecture/kernels_Combined_1x1_+_3x3.png)
